...
public class BrokerService implements Closeable {
    ...
    public void addTopicEventListener(TopicEventsListener... listeners) {
        ...
        for (TopicEventsListener listener : listeners) {
            if (listener != null) {
                topicEventListeners.add(listener);
            }
        }
    ...
    private CompletableFuture<Void> deleteTopicInternal(String topic, boolean forceDelete, boolean deleteSchema) {
        ...
        deleteTopicAuthenticationFuture.whenComplete((v, ex) -> {
            ...
            CompletableFuture<ManagedLedgerConfig> mlConfigFuture = getManagedLedgerConfig(tn);
